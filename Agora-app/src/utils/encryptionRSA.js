...
const RSACrypto = {
	...
	request: async function requestPublicKey() {
		...
		if (response.ok) {
			...
			//export JWK formatted RSA public key for later use: maybe not necessary to import and export key yet
	...
	// ACTUALLY USEFUL FOR PROVIDING VERIFICATION/AUTHENTICATION OF MESSAGES TO AND FROM SERVER!!!
